...
Status: r04 final approved requirements revision  
Revision basis: r03 plus final M3 traceability amendment; no source refresh  
...
| SR-FLOW | Determine whether simultaneous solar export and grid battery charging can occur, or whether those flows are constrained. | Net-value/capability refinement `5465379423`. |
...
- Are import/export fields mutually exclusive net powers and what meter/CT boundary applies? For SR-FLOW, can tenant zero naturally demonstrate simultaneous solar export and grid battery charging, or is later controlled verification/equivalent evidence required?
